...
$resT = mysqli_query($conexion, "SELECT t.titulo, t.clase_id_clase, c.nombre AS clase FROM tarea t JOIN clase c ON t.clase_id_clase=c.id_clase WHERE t.id_tarea='$id_tarea'");
